...
const Hero = () => {
  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center overflow-x-hidden overflow-y-visible bg-transparent">
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pt-24 pb-16 sm:px-6 sm:pt-28 sm:pb-20 md:px-10 lg:px-14">
        <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12 xl:gap-16">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <motion.p
              ...
              className="mb-8 max-w-md text-base leading-relaxed text-text-dim sm:mb-10 sm:text-lg"
            >
